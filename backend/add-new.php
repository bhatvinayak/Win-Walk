                ...
                <main>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['new-post'])) {
                            ...
                            $sql = "INSERT INTO posts (post_category_id, post_title, post_detail, post_image, post_date, post_status, post_author, post_views, post_comment_count) VALUES (:id, :title, :detail, :image, :date, :status, :author, :views, :comment)";
                            $stmt = $pdo->prepare($sql);
                            $stmt->execute([
                                ':id' => $post_category_id,
                                ':title' => $post_title,
