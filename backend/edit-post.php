        ...
        <div id="layoutSidenav">
            ...
            <?php 
                if(isset($_POST['edit-post'])) {
                    ...
                    $url = "http://localhost/winwalker/backend/edit-post.php?post_id=".$post_id;
                    header("Location: {$url}");
                }
            ?>
                ...
                <main>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['update'])) {
                            ...
                            $sql = "UPDATE posts SET post_title = :title, post_status = :status, post_category_id = :cat_id, post_image = :image, post_detail = :detail WHERE post_id = :id";
                            $stmt = $pdo->prepare($sql);
                            $stmt->execute([
                                ':title' => $post_title,
                                ':status' => $post_status,
