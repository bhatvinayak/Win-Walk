 <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <?php
                    if($curr_page == 'all-post.php' || $curr_page == 'new-page.php' || $curr_page == 'add-new.php' || $curr_page== 'edit-post.php') { ?>
                ...
                ?>
                    ...
                    <?php
                        if($curr_page == 'messages.php' || $curr_page == 'reply.php' || $curr_page == 'users.php') { ?>
